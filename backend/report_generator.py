...
class ReportGenerator:
    ...
    def generate_vulnerability_report(self, port_scan_results, 
                                   cms_scan_results, 
                                   output_filename="shieldeye_report.pdf"):
        # generate PDF report
    ...
    def create_title_page(self):
        ...
        elements.append(Paragraph("See the threats before they see you", self.styles['CustomHeading']))  # tagline
    ...
    def create_executive_summary(self, port_scan_results, cms_scan_results):
        elements = []
    ...
    def create_port_scan_section(self, port_scan_results):
        elements = []
    ...
    def create_cms_scan_section(self, cms_scan_results):
        elements = []
